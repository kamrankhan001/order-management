        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="">Change credentials</a></li>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="../../templates/admin/pizza.php">Pizza</a>
                                    <a class="nav-link" href="../../templates/admin/fries.php">Fries</a>
                                    <a class="nav-link" href="../../templates/admin/dranks.php">Dranks</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="order" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="../../templates/admin/allorder.php">All Orders</a>
                                </nav>
                            </div>
                        </div>
                    </div>
